module.exports = {
    ...
    async execute (client,msg) {
        if (client.db.get(`premium.${msg.author.id}.active`)) return msg.reply("Thanks for buying Qeane Premium! The cooldown between commands is gone!!")
        msg.reply("",{embed: {
            title: "Qeane Premium",
            ...
            fields: [
                ...
                {name: "What will I unlock if I buy premium?", value: "If you buy premium, you will not unlock anything. You will also not have to wait 3 seconds between commands"}
            ]
        }})
    }
}