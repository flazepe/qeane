module.exports = {
    ...
    async execute(_client, msg) {
        if (!msg.args.join(' ')) return msg.channel.send('I can\'t purge nothing!')
        ...
        if (!amount || amount < 2 || amount > 100) return msg.channel.send('Invalid number! Please provide a number between 1 and 99')
