module.exports = {
    ...
    async execute(client,msg) {
       ...
       fields.push({name: "Links", value: `[Invite](https://discord.com/api/oauth2/authorize?client_id=727163097026003004&permissions=8&scope=bot) | [Support server](https://discord.gg/2VVU83B) | [Buy Premium](https://donatebot.io/checkout/674514067368574976?id=f97wr8mz2X)`})
       msg.reply("",{embed: {
